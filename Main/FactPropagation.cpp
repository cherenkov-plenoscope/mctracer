...
int main(int argc, char* argv[]) {
    ...
    vector<re::sensor::Sensor*> channels;
    ...
    for (
        ...
        re::sensor::Sensor* pixel_sensor = new re::sensor::Sensor(
            chid,
            pixel_aperture);
        channels.push_back(pixel_sensor);
    }

    re::sensor::Sensors pixels = re::sensor::Sensors(channels);
