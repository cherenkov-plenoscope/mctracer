...
class HomTra3 {
 ...
 public:
    ...
    Vec3 orientation(const Vec3& ori)const;
    Vec3 orientation_inverse(const Vec3& ori)const;
    Vec3 position(const Vec3& pos)const;
    Vec3 position_inverse(const Vec3& pos)const;
