...
#ifndef MERLICT_SCENERY_SEGMENTED_IMAGING_REFLECTOR_GEOMETRY_H_
#define MERLICT_SCENERY_SEGMENTED_IMAGING_REFLECTOR_GEOMETRY_H_
...
#endif  // MERLICT_SCENERY_SEGMENTED_IMAGING_REFLECTOR_GEOMETRY_H_
