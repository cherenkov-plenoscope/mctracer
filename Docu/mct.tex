...
\lstdefinestyle{MctCpp}{%
    ...
    basicstyle=\footnotesize\linespread{0.8}\sffamily,
    numbers=left,
    numberstyle=\normalfont\tiny\color{LightGray},
    xleftmargin=0.75cm,
}

\lstdefinestyle{MctXml}{%
    language=C++,
    keywordstyle=\bfseries,
    commentstyle=\itshape,
    rangeprefix=<!--,rangesuffix=-->,
...
\newcommand{\XmlFileStartEnd}[3]{%
\begin{minipage}{\linewidth}%
\vspace{3mm}%
\textcolor{LightGray}{\path{#1}}%
\vspace{-1mm}%
\lstinputlisting[linerange=#2-#3, style=MctXml]{#1}%
\end{minipage}%
}%

\newenvironment{bash}[1]
{\begin{minipage}{\linewidth}\begin{lstlisting}[style=MctBash]#1}
