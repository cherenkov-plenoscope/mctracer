...
ZaxisCylinderRayIntersectionEquation::ZaxisCylinderRayIntersectionEquation(
	...
	const double sxdx = ray->get_support().x*ray->direction().x;
	const double sydy = ray->get_support().y*ray->direction().y;
...
//------------------------------------------------------------------------------
bool ZaxisCylinderRayIntersectionEquation::one_intersec_behind_and_one_in_front_ray_sup() {
...
//------------------------------------------------------------------------------
double ZaxisCylinderRayIntersectionEquation::get_ray_parameter_for_intersection()const {
