...
TEST_F(FramesTest, too_close_together_false) {
    ...
    Frame f2;
    f2.set_name_pos_rot("f2", Vec3(0,0,10.0*Frame::MIN_STRUCTURE_SIZE), Rot3::UNITY);
...
TEST_F(FramesTest, optimal_bounding_sphere_pos_many_frames_symetric) {
	...
	vector<Frame*> vf;
    Frame f1; f1.set_name_pos_rot("f1", Vec3(0,0,0), Rot3::UNITY); vf.push_back(&f1);
    Frame f2; f2.set_name_pos_rot("f2", Vec3(1,0,0), Rot3::UNITY); vf.push_back(&f2);
    Frame f3; f3.set_name_pos_rot("f3", Vec3(2,0,0), Rot3::UNITY); vf.push_back(&f3);
   	Frame f4; f4.set_name_pos_rot("f4", Vec3(3,0,0), Rot3::UNITY); vf.push_back(&f4);
    Frame f5; f5.set_name_pos_rot("f5", Vec3(4,0,0), Rot3::UNITY); vf.push_back(&f5);
...
TEST_F(FramesTest, optimal_bounding_sphere_pos_many_spheres_symetric) {
	...
	vector<Frame*> vf;
    Sphere f1; f1.set_name_pos_rot("f1", Vec3(0,0,0), Rot3::UNITY); f1.set_radius(1.0); vf.push_back(&f1);
    Sphere f2; f2.set_name_pos_rot("f2", Vec3(1,0,0), Rot3::UNITY); f2.set_radius(1.0); vf.push_back(&f2);
    Sphere f3; f3.set_name_pos_rot("f3", Vec3(2,0,0), Rot3::UNITY); f3.set_radius(1.0); vf.push_back(&f3);
   	Sphere f4; f4.set_name_pos_rot("f4", Vec3(3,0,0), Rot3::UNITY); f4.set_radius(1.0); vf.push_back(&f4);
    Sphere f5; f5.set_name_pos_rot("f5", Vec3(4,0,0), Rot3::UNITY); f5.set_radius(1.0); vf.push_back(&f5);
	EXPECT_EQ(Vec3(2,0,0), Frames::dumb_bounding_sphere_center(vf));
}
//------------------------------------------------------------------------------
TEST_F(FramesTest, optimal_bounding_sphere_pos_many_spheres_asymetric) {
    ...
    Sphere f3; f3.set_name_pos_rot("f3", Vec3(2,0,0), Rot3::UNITY); f3.set_radius(1.0); vf.push_back(&f3);
   	Sphere f4; f4.set_name_pos_rot("f4", Vec3(3,0,0), Rot3::UNITY); f4.set_radius(1.0); vf.push_back(&f4);
    Sphere f5; f5.set_name_pos_rot("f5", Vec3(4,0,0), Rot3::UNITY); f5.set_radius(5.0); vf.push_back(&f5);
...
TEST_F(FramesTest, not_optimal_in_symetric_case) {
    ...
    vector<Frame*> vf;
    Sphere f1; f1.set_name_pos_rot("f1", Vec3(cos(Deg2Rad(  0.0)), sin(Deg2Rad(  0.0)),0), Rot3::UNITY); f1.set_radius(0.5); vf.push_back(&f1);
    Sphere f2; f2.set_name_pos_rot("f2", Vec3(cos(Deg2Rad(120.0)), sin(Deg2Rad(120.0)),0), Rot3::UNITY); f2.set_radius(0.5); vf.push_back(&f2);
    Sphere f3; f3.set_name_pos_rot("f3", Vec3(cos(Deg2Rad(240.0)), sin(Deg2Rad(240.0)),0), Rot3::UNITY); f3.set_radius(0.5); vf.push_back(&f3);
