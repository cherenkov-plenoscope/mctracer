...
TEST_F(RayAndFrameBoundingSphereTest, frame_has_bounding_sphere) {
    Sphere sphere("sphere", VEC3_ORIGIN, Rot3::UNITY);
...
TEST_F(RayAndFrameTest, transform_into_unit_frame) {
    Frame frame;
    frame.set_name_pos_rot("frame", VEC3_ORIGIN, Rot3::UNITY);
...
TEST_F(RayAndFrameTest, transform_into_translated_frame) {
    Frame frame;
    frame.set_name_pos_rot("frame", Vec3(0.0, 0.0, 13.37), Rot3::UNITY);
    frame.init_tree_based_on_mother_child_relations();
...
TEST_F(RayAndFrameTest, causal_intersection) {
    ...
    spheres_in_a_row.set_name_pos_rot("spheres", VEC3_ORIGIN, Rot3::UNITY);

    Sphere* s0 = spheres_in_a_row.append<Sphere>();
    s0->set_name_pos_rot("s0", Vec3(0.0, 0.0, 0.0), Rot3::UNITY);
    s0->set_radius(1.0);
    Sphere* s1 = spheres_in_a_row.append<Sphere>();
    s1->set_name_pos_rot("s1", Vec3(0.0, 3.0, 0.0), Rot3::UNITY);
    s1->set_radius(1.0);
    Sphere* s2 = spheres_in_a_row.append<Sphere>();
    s2->set_name_pos_rot("s2", Vec3(0.0, 6.0, 0.0), Rot3::UNITY);
    s2->set_radius(1.0);
    Sphere* s3 = spheres_in_a_row.append<Sphere>();
    s3->set_name_pos_rot("s3", Vec3(0.0, 9.0, 0.0), Rot3::UNITY);
    s3->set_radius(1.0);
    Sphere* s4 = spheres_in_a_row.append<Sphere>();
    s4->set_name_pos_rot("s4", Vec3(0.0, 12.0, 0.0), Rot3::UNITY);
    s4->set_radius(1.0);
