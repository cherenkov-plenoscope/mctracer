...
TEST_F(RayAndFrameBoundingSphereTest, frame_has_bounding_sphere) {
    ...
    Sphere sphere("sphere", Vec3::ORIGIN, Rot3::UNITY);
...
TEST_F(RayAndFrameTest, transform_into_unit_frame) {
    ...
    Frame frame;
    frame.set_name_pos_rot("frame", Vec3::ORIGIN, Rot3::UNITY);
...
TEST_F(RayAndFrameTest, causal_intersection) {
    ...
    spheres_in_a_row.set_name_pos_rot("spheres", Vec3::ORIGIN, Rot3::UNITY);
