...
const Func1D* SurfaceEntity::DEFAULT_REFLECTION = new Func1D(
    {
        {200e-9, 0},
        {1200e-9, 0}
    });

const Func1D* SurfaceEntity::DEFAULT_REFRACTION = new Func1D(
    {
        {200e-9, 1},
        {1200e-9, 1}
    });

const Func1D* SurfaceEntity::DEFAULT_ABSORPTION = new Func1D(
    {
