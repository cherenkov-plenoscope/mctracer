...
namespace Frames {
    ...
    bool positions_in_mother_are_too_close_together(const std::vector<Frame*> &frames);
    double bounding_sphere_radius(const std::vector<Frame*> &frames, const Vec3 center);
}
