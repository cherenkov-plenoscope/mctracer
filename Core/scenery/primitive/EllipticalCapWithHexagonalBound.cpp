...
#include "Core/scenery/primitive/EllipticalCapWithHexagonalBound.h"
#include <math.h>
#include <sstream>
using std::string;
...
void EllipticalCapWithHexagonalBound::
    ...
    double sphere_center_to_edge_in_z = sqrt(
        Z_curvature_radius*Z_curvature_radius -
...
std::string EllipticalCapWithHexagonalBound::str()const {
