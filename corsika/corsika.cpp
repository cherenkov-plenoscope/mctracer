...
string get_print(const array<float, 273> &eh) {
  ...
  out << "  7 " << "z coordinate (height) of first interaction " << eh[7-1];
    out << "cm\n";
  ...
  out << " 63 " << "cutoff for electrons kinetic energy " << eh[63-1];
    out << "GeV\n";
  ...
  out << " 71 " << "x component of Earth’s magnetic field " << eh[71-1];
    out << "uT\n";
  out << " 72 " << "z component of Earth’s magnetic field " << eh[72-1];
    out << "uT\n";
