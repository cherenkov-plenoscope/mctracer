...
class Geometry {
 public:
    // PIXEL: picture cell
    std::vector<merlict::Vec3> pixel_grid;
    std::vector<std::vector<unsigned int>> pixel_neighborhood;

    // PAXEL: principal aperture cell
    std::vector<merlict::Vec3> paxel_per_pixel_template_grid;
    std::vector<std::vector<unsigned int>> paxel_neighborhood;

    std::vector<merlict::Vec3> paxel_grid_centers_of_pixels;

    // LIXEL: light field cell
    std::vector<merlict::Vec3> lixel_grid;
