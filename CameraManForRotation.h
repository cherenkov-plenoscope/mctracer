...
private:
	...
	void decrease_rot_y();
	void print_camera_rotation_for_y_axis_manipulation()const;
	void increase_rot_z();
	void decrease_rot_z();
	void print_camera_rotation_for_z_axis_manipulation()const;
	void assert_RotWorld2CameraZ_is_not_overtwisting();
	double rotation_increment()const;
	void print_camera_can_not_look_further(const std::string dir)const;
};
