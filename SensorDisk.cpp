...
//==================================================================
SensorDisk::SensorDisk(){
	reflection.set_reflection_coefficient(0.0);
	flag_sensor = true;
}
//==================================================================
SensorDisk::~SensorDisk(){
	std::cout<<"Sensor-disk-> deconstruct"<<std::endl;
	list_of_hits.clear();
}
//==================================================================
/*
void SensorDisk::push_back_intersection(
...
//==================================================================	
void SensorDisk::push_back_SensorIntersection
(SensorIntersection *pointer_to_new_sensor_hit){
	list_of_hits.push_back(pointer_to_new_sensor_hit);
}
//==================================================================
std::string SensorDisk::get_string()const{
	std::stringstream out;
	out<<"Sensor_Disk: Number of hits: ";
	out<<list_of_hits.size()<<std::endl;
	return out.str();
}	
//==================================================================
std::string SensorDisk::get_full_string()const{
	std::stringstream out;
	out<<"Sensor_Disk: list of hits"<<std::endl;
...
//==================================================================
std::string SensorDisk::get_csv_string()const{
	std::stringstream out;
	//out<<"% Sensor_Disk FACT raytracing"<<endl;
...
//==================================================================
void SensorDisk::disp()const{
	std::cout<<get_string();
}
//==================================================================
void SensorDisk::disp_full_table_of_intersections()const{
	std::cout<<get_full_string();
}
//==================================================================
void SensorDisk::export_csv_table_of_intersections(std::string str_file_name)const{
...
if (myfile.is_open())
{
	...
	{
		std::cout<<"Sensor-disk->export_csv_table_of_intersections():";
		std::cout<<" Unable to open file: "<<str_file_name<<std::endl;
	}
}
//==================================================================
void SensorDisk::clear_intersection_list(){

	list_of_hits.clear();
	std::cout<<"Sensor-disk->clear_intersection_list()"<<std::endl;
