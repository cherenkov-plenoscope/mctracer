...
int main(){
	...
	settings.set_max_number_of_reflections(1);
	
	//==================================================================
	// open / read file
	//==================================================================
	/*
	cl_file2world file2world;
	file2world.set_file_name("world.txt");
	//file2world.ask_file_name();
	file2world.disp();
	if(!file2world.read_file()){return false;}
	*/
...
//======================================================================
		...
		rot.set_rotation(0.0,0.0,((M_PI*2.0)/360.0)*0.0);
		disk.set_frame("GAPD_camera_window",pos,rot);
		col.set_colour_0to255(230,230,215);
		refl.set_reflection_coefficient(0.0);	
		disk.set_surface_properties(&refl,&col);
		disk.set_disk(0.33);
		
		Disk 	disk2;
		pos.set_vec3D(0.0,0.0,0.89);
		rot.set_rotation(0.0,0.0,((M_PI*2.0)/360.0)*0.0);
		disk2.set_frame("GAPD_camera_top",pos,rot);
		col.set_colour_0to255(230,230,215);
		refl.set_reflection_coefficient(0.0);	
		disk2.set_surface_properties(&refl,&col);
		disk2.set_disk(0.33);
			
		SensorDisk 	sensor_disk;
		pos.set_vec3D(0.0,0.0,0.0);
		rot.set_rotation(0.0,0.0,0.0);
		sensor_disk.set_frame("GAPD_camera_sensor_disk",pos,rot);
		col.set_colour_0to255(0,255,128);
		refl.set_reflection_coefficient(0.0);	
		sensor_disk.set_surface_properties(&refl,&col);
		sensor_disk.set_disk(0.195);
		//sensor_disk.set_disk(3.0);
	
		SensorDisk 	garbage_esensor_disk;
		pos.set_vec3D(0.0,0.0,-1.0);
		rot.set_rotation(0.0,0.0,0.0);
		garbage_esensor_disk.set_frame("GAPD_camera_sensor_disk",pos,rot);
		col.set_colour_0to255(155,128,128);
		refl.set_reflection_coefficient(0.0);	
		garbage_esensor_disk.set_surface_properties(&refl,&col);
		garbage_esensor_disk.set_disk(4.0);
		//sensor_disk.set_disk(3.0);
		...
		Disk 	disk_little_sensor;
		pos.set_vec3D(0.0,0.0,4.891+shift_in_m);
		rot.set_rotation(0.0,0.0,((M_PI*2.0)/360.0)*0.0);
		disk_little_sensor.set_frame("disk_little_sensor",pos,rot);
		col.set_colour_0to255(230,230,215);
		refl.set_reflection_coefficient(0.0);	
		disk_little_sensor.set_surface_properties(&refl,&col);
		disk_little_sensor.set_disk(0.03);
			
		SensorDisk 	little_sensor_disk;
		pos.set_vec3D(0.0,0.0,4.89+shift_in_m);
		rot.set_rotation(0.0,0.0,0.0);
		little_sensor_disk.set_frame("little_sensor_disk",pos,rot);
		col.set_colour_0to255(0,255,128);
		refl.set_reflection_coefficient(0.0);	
		little_sensor_disk.set_surface_properties(&refl,&col);
		little_sensor_disk.set_disk(0.025);
		//little_sensor_disk.set_disk(3.0);
		*/
		//==============================================================
		...
		GAPD_camera.set_mother_and_child(&sensor_disk);
		GAPD_camera.set_mother_and_child(&disk);
		GAPD_camera.set_mother_and_child(&disk2);
		...
		*/
		...
		world.set_mother_and_child(&garbage_esensor_disk);
		world.set_mother_and_child(&fact); 
		/*
		wo0rld.set_mother_and_child(&test_ellipsoid);
		world.set_mother_and_child(&little_sensor_disk);
		world.set_mother_and_child(&disk_little_sensor);
		*/
		//world.set_mother_and_child(&sensor_disk);
		...
		*/
		...
		free.set_free_orbit(&world,&settings);
		...
		sensor_disk.export_csv_table_of_intersections(export_csv_table_name);
		sensor_disk.clear_intersection_list();
		
		string export_shadow_csv_table_name = export_file_name.str() += "shadow_csv_table.csv";
		garbage_esensor_disk.
		export_csv_table_of_intersections(export_shadow_csv_table_name);
		garbage_esensor_disk.clear_intersection_list();
