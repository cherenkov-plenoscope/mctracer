...
int main(int argc, char* argv[]) {
	...
	cmd.define_key_val_by_key_short_desc("config", 'c' ,"configuration file controling the simulation");
	cmd.define_key_val_by_key_short_desc("output", 'o', "output path");
	cmd.define_key_val_by_key_short_desc("input", 'i', "input path for CORSIKA Cherenkov photons");
	cmd.parse(argc, argv);
