...
world= Frame("World", Vec3.null, Rotation3D.null)
tree= Frame("My_Tree", Vec3(5.0, 0.0, 0.0), Rotation3D.null)



leaf_ball = Sphere("leaf_ball", Vec3(0.0, 0.0, 2.0), Rotation3D.null)
leaf_ball.set_outer_color(Color(0, 128, 0))
leaf_ball.set_radius(0.5)


tree_pole = Cylinder("tree_pole", Vec3(0.0, 0.0, 0.5), Rotation3D.null)
...
house = Frame("house", Vec3(0.0, -5.0, 0.0), Rotation3D.null)

foundation_gray = Color(32, 32, 32)

foundation = Plane("foundation", Vec3(0.0, 0.0, 0.01), Rotation3D.null)
foundation.set_outer_color(foundation_gray)
foundation.set_inner_color(foundation_gray)
foundation.set_x_y_width(4.5, 4.5)

front_wall = Plane("wall1", Vec3(0.0, 0.0, 0.0), Rotation3D.null)
