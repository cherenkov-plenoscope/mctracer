...
//------------------------------------------------------------------------------
void Rotation::print_when_verbose_camera_rotation_for_y_axis_manipulation()const {
	if(verbose) {
...
//------------------------------------------------------------------------------
void Rotation::print_when_verbose_camera_rotation_for_z_axis_manipulation()const {
	if(verbose) {
